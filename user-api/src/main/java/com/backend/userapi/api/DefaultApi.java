...
public interface DefaultApi {
    ...
    ResponseEntity<LoginResp> login(
        @Parameter(name = "LoginReq", description = "") @Valid @RequestBody(required = false) LoginReq loginReq
    );
